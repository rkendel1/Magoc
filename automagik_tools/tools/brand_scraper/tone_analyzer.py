...
class ToneAnalyzer:
    ...
    def __init__(self, timeout: int = 30, user_agent: str = "", max_text_length: int = 10000):
        ...
        self.tone_keywords = {
            "formal": ["therefore", "furthermore", "moreover", "consequently", "nevertheless"],
            "casual": ["hey", "cool", "awesome", "yeah", "super", "totally"],
            "professional": ["expertise", "experience", "solutions", "services", "commitment"],
            "friendly": ["welcome", "happy", "excited", "love", "enjoy"],
            "technical": ["optimize", "algorithm", "infrastructure", "implementation", "architecture"],
    ...
    def _simple_sentiment(self, text: str) -> Dict[str, Any]:
        ...
        positive_words = [
            ...
            "best", "awesome", "perfect", "happy", "delighted", "excited", "innovative"
        ]
        negative_words = [
            "bad", "terrible", "awful", "poor", "worst", "hate", "disappointed",
            "difficult", "problem", "issue", "error", "fail", "wrong"
        ]
    ...
    def _analyze_characteristics(self, text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "formality_indicator": "formal" if avg_word_length > 5 and first_person < 5 else "casual",
        }
