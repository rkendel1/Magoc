...
class TestImageExtractor:
    ...
    async def test_make_absolute_url(self):
        ...
        absolute = extractor._make_absolute_url("https://cdn.example.com/image.jpg", "https://example.com")
        assert absolute == "https://cdn.example.com/image.jpg"
        
        # Test protocol-relative URL
        absolute = extractor._make_absolute_url("//cdn.example.com/image.jpg", "https://example.com")
        assert absolute == "https://cdn.example.com/image.jpg"
